                        ...
                        <div class="row">
                            ...
                            <div class="text-center">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <h5>'.(($value->{'StatusID'} == '34')?'<a href="modul-library-detail.php?m=13&bookid='.$value->{'BookID'}.'&page='.$page.'&itemsperpage='.$itemsperpage.'&redirect='.urlencode('modul-public-detail.php?m=22&bookid='.$value->{'BookID'}.'&itemsperpage='.$itemsperpage).'"><i class="ti-pencil-alt"></i> '.Core::lang('submit_review').'</a>':'<a href="#" data-toggle="modal" data-target="#infoPayment'.$value->{'Guid'}.'">'.Core::lang('buy_this_book').'</a>').'</h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">';
                        ...
                        <div class="modal fade" id="view'.$value->{'Guid'}.'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                          <div class="modal-dialog modal-lg" role="document">
                            ...
                            echo $datatags.'</small> </h2>
                                    ...
                                    <div class="typo-line">
                                        <h5><p class="category">'.Core::lang('detail').'</p>'.(($value->{'StatusID'} == '34')?'<a href="modul-library-detail.php?m=13&bookid='.$value->{'BookID'}.'&page='.$page.'&itemsperpage='.$itemsperpage.'&redirect='.urlencode('modul-public-detail.php?m=22&bookid='.$value->{'BookID'}.'&itemsperpage='.$itemsperpage).'"><i class="ti-pencil-alt"></i> '.Core::lang('submit_review').'</a>':'<a href="#" data-toggle="modal" data-target="#infoPayment'.$value->{'Guid'}.'">'.Core::lang('buy_this_book').'</a>').'</h5>
                                    </div>
                              </div> 
                              <!-- End Modal Body -->
                              <div class="modal-footer">';
