...
<head>
    <title><?php echo Core::lang('explore_file')?> - <?php echo Core::getInstance()->title?></title>
		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><?php echo Core::lang('explore_file')?></a>
                </div>
                <?php include 'global-nav.php';?>
            </div>
        </nav>

            <?php include 'tab-explore.php';?>
