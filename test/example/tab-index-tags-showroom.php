...
<?php 
    $url = Core::getInstance()->api.'/book/data/index/tags/showroom/'.$datalogin['username'].'/'.$datalogin['token'].'/'.$page.'/'.$itemsperpage.'/?query='.rawurlencode($search);
            ...
            if ($data->{'status'} == "success")
            {
                echo '<div class="col-md-12">
                        <div class="card card-plain">
                            <div class="header">
                                <h4 class="title text-uppercase">'.Core::lang('data_tags').'</h4>
                                <p class="category">
                ...
                foreach ($data->results as $name => $value) 
	            {
					...
					echo '<td><a href="modul-book-showroom.php?m=12&page=1&itemsperpage=12&search='.$value->{'Tags'}.'">' . $value->{'Tags'} .'</a></td>';
        			echo '</tr>';              
                }
                echo '</tbody>
                </table>';
