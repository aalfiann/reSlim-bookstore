...
<?php 
    $url = Core::getInstance()->api.'/book/data/index/translator/showroom/'.$datalogin['username'].'/'.$datalogin['token'].'/'.$page.'/'.$itemsperpage.'/?query='.rawurlencode($search);
    ...
    if (!empty($data))
        {
            if ($data->{'status'} == "success")
            {
                ...
                foreach ($data->results as $name => $value) 
	            {
        			...
        			echo '<td><a href="'.$value->{'Website'}.'" target="_blank">' . $value->{'Website'} .'</a></td>';
                    echo '</tr>';              
                }
                echo '</tbody>
                </table>';
