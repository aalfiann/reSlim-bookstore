    ...
    if (!empty($data))
        {
            if ($data->{'status'} == "success")
            {
                ...
                echo $pagination->makePagination($data,$_SERVER['PHP_SELF'].'?m=16&search='.$_GET['search']);
                        ...
                        <div class="modal fade" id="'.$value->{'SubmitBookID'}.'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <form method="post" action="'.$_SERVER['PHP_SELF'].'?m=16&page='.$_GET['page'].'&itemsperpage='.$_GET['itemsperpage'].'&search='.$_GET['search'].'">
                              <div class="modal-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>Book ID</label>
                                            <input name="bookid" type="text" placeholder="Input your pages here..." class="form-control border-input" value="'.$value->{'BookID'}.'" >
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
