                ...
                <div class="row">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel"><?php echo Core::lang('add_new_api')?></h4>
                              </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-plain">
                            <div class="header">
                                <button type="submit" class="btn btn-wd" data-toggle="modal" data-target="#myModal"><?php echo Core::lang('add_new_api')?></button>
                            </div>
                        </div>
                    </div>
<?php 
    ...
    if (!empty($data))
        {
            if ($data->{'status'} == "success")
            {
                ...
                echo '<div class="col-md-12">
                        <div class="card card-plain">
                            <div class="header">
                                <h4 class="title text-uppercase">'.Core::lang('data_api_key').'</h4>
                        ...
                        <div class="modal fade" id="'.$value->{'ApiKey'}.'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title" id="myModalLabel">'.Core::lang('update_api_key').'</h4>
                              </div>
                              ...
                              <div class="modal-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>'.Core::lang('created').'</label>
                                            <input name="created" type="text" placeholder="'.Core::lang('input_created').'" class="form-control border-input" value="'.$value->{'Created_at'}.'" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>'.Core::lang('api_keys').'</label>
