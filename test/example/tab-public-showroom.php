            ...
            if ($data->{'status'} == "success")
            {
                ...
                foreach ($data->results as $name => $value) 
	            {
                    echo '<div class="col-lg-4 col-md-6">
                        ...
                        <div class="row">
                            <div class="text-center"><a href="modul-public-detail.php?m=22&bookid='.$value->{'BookID'}.'&itemsperpage='.$itemsperpage.'"><img class="lazyload" data-src="' . $value->{'Image'} .'" width="80%"></a></div>
                        </div>
