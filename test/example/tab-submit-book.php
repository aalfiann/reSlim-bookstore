                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" type="text" rows="3" maxlength="250" placeholder="Input the title here..." class="form-control border-input" required></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
    ...
    if (!empty($data))
        {
            if ($data->{'status'} == "success")
            {
                ...
                echo $pagination->makePagination($data,$_SERVER['PHP_SELF'].'?m=17&search='.$search);
                        ...
                        <div class="modal fade" id="'.$value->{'SubmitBookID'}.'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <button type="submit" name="submitdeletebook'.$value->{'SubmitBookID'}.'" class="btn btn-danger pull-left '.(($value->{'StatusID'} != '35')?'hidden':'').'">Delete</button>
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                <button type="submit" name="submitupdatebook'.$value->{'SubmitBookID'}.'" class="btn btn-primary '.(($value->{'StatusID'} != '35')?'hidden':'').'">Update</button>
                              </div>
                              </form>
                            </div>
                          </div>
